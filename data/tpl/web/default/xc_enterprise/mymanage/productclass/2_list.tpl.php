...
<ul class="we7-page-tab">
    ...
    <li > <a href="<?php  echo $this->createWebUrl($_GPC['do'], array('op'=>'edit'));?>">增加</a>
    </li>
                ...
                <div class="ibox-content" id="pfrom">
                    ...
                    <table id="table" class="dotable" data-toggle="table"
                        ...
                        <tr>
                            ...
                            <th data-field="contents.firname" data-sortable="true">一级分类名称</th>
                            <!--<th data-field="contents.petname"  data-sortable="true" >二级分类名称</th>-->
