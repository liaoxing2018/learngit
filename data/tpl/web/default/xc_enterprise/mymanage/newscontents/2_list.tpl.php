...
<ul class="we7-page-tab">
    ...
    <li>
        <a href="<?php  echo $this->createWebUrl($_GPC['do'], array('op'=>'newset'));?>">
            新闻页面设置</a></li>
            ...
            <form action=" " method="get" class="form-horizontal" role="form" id="searchform">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3col-lg-3">
                    ...
                    <select class="form-control" name="cid" data-select="" id="xcid">
                        ...
                        <?php  if(is_array($newclasslist)) { foreach($newclasslist as $index => $newclassitem) { ?>
                        <option value='<?php  echo $newclassitem["id"];?>'><?php  echo $newclassitem["name"];?></option>
                        <?php  } } ?>
                    </select>
                    </div>
                <?php  } ?>
                ...
                <div class="ibox-content" id="pfrom">
                    ...
                    <table id="table" class="dotable" data-toggle="table"
                        ...
                        <tr>
                            ...
                            <th data-field="img" data-sortable="true" data-formatter="formatimg">图片</th>
                            <th data-field="about" data-sortable="true" data-width="26%"> 摘要</th>
                            <?php  if($newclasslist > 0) { ?>
                            <th data-field="cid"  data-sortable="true" >分类</th>
                            <?php  } ?>
                            <th data-field="status" data-sortable="true" data-formatter="formatstatus"
                                data-events="operatestatus">状态
                            </th>
                            <th data-field="isindex" data-sortable="true" data-formatter="formatisindex"
...
<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/managelistjs', TEMPLATE_INCLUDEPATH)) : (include template('common/managelistjs', TEMPLATE_INCLUDEPATH));?>
