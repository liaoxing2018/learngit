...
<title><?php  echo $webset['name'];?>-新闻资讯<?php  echo $xtitle;?></title>
...
<div class="newsCont">
    ...
    <div class="nav">
        ...
        <?php  if(is_array($news_class)) { foreach($news_class as $news_index => $nc) { ?>
        <a data-id="<?php  echo $nc['id'];?>" href="<?php  echo $this->createMobileUrl($do,array('op'=>'news','cid'=>$nc['id']))?>"><?php  echo $nc['contents'];?></a>
        <?php  } } ?>
